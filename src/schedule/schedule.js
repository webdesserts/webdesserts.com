...
let Slot = styled.div`
  background-color: ${(props) =>
    props.active ? "var(--lite-1)" : "var(--lite)"};
  height: 4px;
...
export class Schedule extends React.Component {
  constructor(props) {
    ...
    this.schedule = {
      ...
      weekend: [{ hours: 24, active: false, name: "whatever" }],
    };
  }
  ...
  getTodaysSchedule(now) {
    switch (now.getDay()) {
      ...
      case 3:
      case 5:
        return this.schedule.local;
      case 2:
      case 4:
        return this.schedule.remote;
      default:
  ...
  render() {
    ...
    hour += Math.floor(minutes / 15) * 0.25;
